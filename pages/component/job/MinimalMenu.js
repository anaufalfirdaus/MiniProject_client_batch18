...
function MinimalMenu() {
  return (
    <Menu as="div" className="ml-2 relative inline-block text-left">
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 mb w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
